 ...
 *
 */
public class SilentPackageException extends PackageException {
	 ...
	 * @param message
	 */
	public SilentPackageException(String message) {
		super(message);
	}
	 ...
	 * @param cause
	 */
	public SilentPackageException(String message, Throwable cause) {
		super(message, cause);
	}
	 ...
	 * @param cause
	 */
	public SilentPackageException(Throwable cause) {
		super(cause);
	}
