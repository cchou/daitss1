  ...
  <xsl:template match="r:FILES">
    ...
    <div class="files">
        ...
        <table>
          ...
          <xsl:for-each select="$rfiles">
            ...
            <tr>
              ...
              <td align="center"><xsl:value-of select="@PRESERVATION"/></td>
              <td align="center"><xsl:value-of select="@ORIGIN"/></td>
              <td align="center"><xsl:value-of select="@GLOBAL"/></td>
              <td align="center">
              ...
              <td align="center">
                <xsl:choose>
                  <xsl:when test="count( r:BROKEN_LINK[parent::*/@PRESERVATION = 'FULL'] ) > 0">
                    <a href="#BL_{@DFID}">
      ...
      <div class="listing">
        <h4>Broken Links</h4>
        <xsl:for-each select="$rfiles">
          <xsl:if test="count(r:BROKEN_LINK[parent::*/@PRESERVATION = 'FULL']) > 0">
            <div class="ftitle">
